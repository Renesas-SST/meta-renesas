...
do_install() {
    ...
    install -m 0755 ${WORKDIR}/quickboot-cli/disable_networking_stack.sh ${D}/home/root/network-management
    install -m 0755 ${WORKDIR}/quickboot-cli/enable_networking_stack.sh ${D}/home/root/network-management
}
