...
SRC_URI = " \
    file://r11qs0072eu0300-rz-cmn-srp-um-quick-start-guide.pdf \
    file://r12uz0204eu0300-rz-cmn-srp-um.pdf \
...
do_install () {
    install -d ${D}/util
    install -m 0644 ${S}/r11qs0072eu0300-rz-cmn-srp-um-quick-start-guide.pdf ${D}/util/r11qs0072eu0300-rz-cmn-srp-um-quick-start-guide.pdf
    install -m 0644 ${S}/r12uz0204eu0300-rz-cmn-srp-um.pdf ${D}/util/r12uz0204eu0300-rz-cmn-srp-um.pdf
...
do_deploy () {
    ...
    install -d ${DEPLOYDIR}/
    install -m 0644 ${D}/util/r11qs0072eu0300-rz-cmn-srp-um-quick-start-guide.pdf ${DEPLOYDIR}/
    install -m 0644 ${D}/util/r12uz0204eu0300-rz-cmn-srp-um.pdf ${DEPLOYDIR}/
