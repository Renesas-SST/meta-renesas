...
SUMMARY = "RZ/G2L-SBC Documentation and Licenses"
DESCRIPTION = "User guides and license documents for RZ/G2L-SBC"
...
SRC_URI = " \
    file://r11qs0066eu0200-rz-srp-yocto5-um-quick-start-guide.pdf \
    file://r12uz0195eu0200-rz-srp-yocto5-um.pdf \
...
do_install () {
    install -d ${D}/util
    install -m 0644 ${S}/r11qs0066eu0200-rz-srp-yocto5-um-quick-start-guide.pdf ${D}/util/r11qs0066eu0200-rz-srp-yocto5-um-quick-start-guide.pdf
    install -m 0644 ${S}/r12uz0195eu0200-rz-srp-yocto5-um.pdf ${D}/util/r12uz0195eu0200-rz-srp-yocto5-um.pdf
...
do_deploy () {
    ...
    install -d ${DEPLOYDIR}/
    install -m 0644 ${D}/util/r11qs0066eu0200-rz-srp-yocto5-um-quick-start-guide.pdf ${DEPLOYDIR}/
    install -m 0644 ${D}/util/r12uz0195eu0200-rz-srp-yocto5-um.pdf ${DEPLOYDIR}/
